...
function ExploreCard({ restorent }) {
  ...
  return (
    <div className="main relative cursor-pointer w-full flex flex-col justify-center h-auto hover:shadow-2xl bg-white p-3 pb-10 border-2 border-white hover:border-gray-300 rounded-2xl">
      ...
      <div className="bottom mt-3 flex flex-1 lg:flex-row flex-col justify-between">
